...
/***/ function(module, exports, __webpack_require__) {
	...
	var projects = ['in-flux/component-router', 'nkbt/react-component-template', 'nkbt/react-collapse', 'nkbt/react-swap', 'nkbt/react-debounce-input', 'nkbt/react-copy-to-clipboard', 'nkbt/react-interval', 'nkbt/react-text-filter', 'nkbt/react-page-click', 'nkbt/react-normalized-select', 'nkbt/minicat', 'nkbt/css-modules-component-template', 'nkbt/css-modules-component-template-test', 'nkbt/flux-common-store', 'nkbt/esnext-quickstart', 'nkbt/ng-modular', 'packetloop/angular-webpack'];
	...
	var App = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'div',
	      null,
	      _react2['default'].createElement(_2['default'], { projects: projects })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dashboard = __webpack_require__(155);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'td',
	      { style: { padding: '0.2em 0.6em', whiteSpace: 'nowrap' } },
	...
	var Shield = _react2['default'].createClass({
	  displayName: 'Shield',
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'td',
	      { style: { padding: '0.2em 0.6em', textAlign: 'center' } },
	...
	var Project = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'tr',
	      { style: { backgroundColor: i % 2 ? 'rgba(0, 0, 0, 0.04)' : '' } },
	      _react2['default'].createElement(Link, { project: project }),
	      _react2['default'].createElement(Shield, { project: project, type: 'circleci/project' }),
	      _react2['default'].createElement(Shield, { project: project, type: 'github/tag' }),
	      _react2['default'].createElement(Shield, { project: project, type: 'github/release' }),
	      _react2['default'].createElement(Shield, { project: project.split('/').slice(1).join('/'), type: 'npm/v' }),
	      _react2['default'].createElement(Shield, { project: project.split('/').slice(1).join('/'), type: 'bower/v' }),
	      _react2['default'].createElement(Shield, { project: project, type: 'david' }),
	      _react2['default'].createElement(Shield, { project: project, type: 'david/dev' }),
	      _react2['default'].createElement(Shield, { project: project, type: 'david/peer' })
	    );
	  }
	});
	...
	var Dashboard = _react2['default'].createClass({
	  ...
	  propTypes: {
	    projects: _react2['default'].PropTypes.arrayOf(_react2['default'].PropTypes.string).isRequired
	  },
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        projects.map(function (project, i) {
	          return _react2['default'].createElement(Project, { key: project, project: project, i: i });
	        })
	      )
	    );
	  }
